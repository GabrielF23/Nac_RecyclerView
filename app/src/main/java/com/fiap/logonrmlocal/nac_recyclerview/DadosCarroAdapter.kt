...
class DadosCarroAdapter(private val carro: List<Carro>,
                  private val context: Context,
                  val listener: (Carro) -> Unit) : Adapter<DadosCarroAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindView(carro: Carro,
            ...
            Picasso.get()
                    ...
                    .into(ivImagemCarro)
            tvMarcaCarro.text = carro.marca
            tvModeloCarro.text = carro.modelo
